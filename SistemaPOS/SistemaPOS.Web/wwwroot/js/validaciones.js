...
const RESERVED_WORDS1 = ["SELECT", "INSERT", "UPDATE", "DELETE", "FROM", "WHERE", "GROUP BY", "HAVING", "ORDER BY", "DROP", "CREATE", "ALTER", "TRUNCATE", "EXEC", "NULL", "JOIN", "INNER", "LEFT", "RIGHT", "VALUES"];
const MAX_LENGTH = 30;
